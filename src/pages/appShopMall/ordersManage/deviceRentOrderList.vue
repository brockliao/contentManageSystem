...
<template>
  <div class="content">
    ...
    <div class="deviceBusinessContainer">
      <div class="partTitle">
      ...
      <el-table :data="tabelOptions.items" border style="width: 100%" max-height="tabelOptions.height">
        ...
        <el-table-column prop="amount" label="原价合计" width="100"></el-table-column>
...
export default {
  data: function() {
    return {
      ...
      breadList: [{ label: "应用商城" }, { label: "设备交易订单查询" }]
    };
  },
  computed: {
    State: function() {}
